...
#define CMD_SUSFS_ADD_SUS_PATH_LOOP       0x55569
#define CMD_SUSFS_HIDE_SUS_MNTS_FOR_NON_SU_PROCS 0x5556a
#define CMD_SUSFS_ENABLE_AVC_LOG_SPOOFING 0x5556b
#define CMD_SUSFS_ADD_SUS_MAP             0x5556c
